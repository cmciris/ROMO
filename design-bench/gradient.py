...
def gradient_ascent(**config):
    ...
    # np.save('./visualization/hopper_unnormalized_x.npy', task.x)
    # np.save('./visualization/hopper_unnormalized_y_data.npy', task.y)
    # np.save('./visualization/hopper_unnormalized_y_oracle.npy', task.predict_numpy(task.x))
    if normalize_ys:
    ...
    # np.save('./visualization/hopper_normalized_x.npy', task.x)
    # np.save('./visualization/hopper_normalized_y_data.npy', task.y)
    # np.save('./visualization/hopper_normalized_y_oracle.npy', task.predict_numpy(task.x))
    # exit(0)
