...
class RetrievalInteractionMachine(nn.Module):
    ...
    def __init__(self,
        ...
        super(RetrievalInteractionMachine, self).__init__()
    ...
    def optimize(self, x, steps, pool):
        ...
        def gradient_step(xt):
            ...
            score = self.forward_model.inference(xt, retrieval_set, aggr_grad=self.aggr_grad)
    ...
    def train_step(self, x, y, pool):
        ...
        d = self.forward_model(x, retrieval_set)  # [batch_size, output_dim]
        nll = F.mse_loss(y, d)
